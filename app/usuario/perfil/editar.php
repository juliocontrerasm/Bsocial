	...
	if($_POST['nombre']!=null):
		if ($_POST['nuevo_password']!=null):
			...
			if($usuarios!=null):
				...
				echo "<script language='javascript'>window.location='../perfil/editar.php?save=1'</script>"; 
			else:
				echo "<script language='javascript'>window.location='../perfil/editar.php?error=1'</script>"; 
			endif;
		else:
...
?>
      	<div id="col-centro" class="col-contenido">
			<div id="contenedor-contenido" class="perfil editar">
				<form action="<?=$PHP_SELF?>" method="post" id="editar" onsubmit="return validar();" enctype="multipart/form-data">
					<div id="foto-vacia">
						<?php $url_imagen = '../../usuario/perfil/img/'.$_SESSION['empresa'].'/'.$_SESSION['id_usuario'].'.jpg';
						...
						<h3 class="chico">Cambiar foto de perfil</h3>
						<p class="titulo"><a href="#" title="Eliminar foto de perfil">Eliminar foto de perfil</a></p>
						<p class="titulo"><a rel="#modal-subir-foto" title="Subir nueva foto">Subir nueva foto</a></p>
						<h3 class="chico largo">Información personal</h3>
	 					<p>
	 						<div id ="cargo-content" class="cargo" >
								<div id="cargo-description" ></div>
								<br />
								<label id ="cargo-label" class="bajada" for="cargo" >Cargo</label>
								<br />
	 					...
	 					<p>
	 						<div id ="direccion-content" class="direccion" >
								...
								<br />
								<label id ="direccion-label" class="bajada" for="direccion" >Direccion</label>
								<br />
	 					...
	 					<p>
	 						<div id ="password-content" class="password" >
								...
								<br />
								<label id ="password-label" class="bajada" for="password" >Password</label>
								<br />
						...
						<p>
							<div id ="nuevo-password-content" class="nuevo-password" >
								...
								<br />
								<label id ="nuevo-password-label" class="bajada" for="nuevo-password" >Nuevo password</label>
								<br />
	 					...
	 					<p>
	 						<div id ="r-nuevo-password-content" class="r-nuevo-password" >
								...
								<br />
								<label id ="r-nuevo-password-label" class="bajada" for="r-nuevo-password" >Repita nuevo password</label>
								<br />
