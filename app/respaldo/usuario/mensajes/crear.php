...
?>
Menu: <a href="index.php">Ver mensajes</a> | <a href="crear.php">Crear mensajes</a> | <a href="salida.php">Ver mensajes enviados</a> | <a href="cerrar.php">Cerrar sesion</a><br /><br />
...
<input type="submit" name="enviar" value="Enviar" />
	...
	$(function() {
       ...
       autocompletar = <?php echo json_encode($result); ?>;*/
